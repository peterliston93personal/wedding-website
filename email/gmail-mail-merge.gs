...
function getHtmlTemplate_() {
  return [
    ...
    // Names + intro
    '<tr><td style="padding:60px 40px 24px 40px; text-align:center; font-family:\'Source Serif 4\', Georgia, \'Times New Roman\', serif; color:#1a1a1a; background-color:#E8E4DC;">',
    '<p style="margin:0; font-size:70px; line-height:1.05; font-style:italic; letter-spacing:-0.5px;">Tara</p>',
    '<p style="margin:0; padding:10px 0; font-size:16px; line-height:1; letter-spacing:4px; text-transform:uppercase; color:#8a847a; font-style:normal;">&amp;</p>',
    '<p style="margin:0; font-size:70px; line-height:1.05; font-style:italic; letter-spacing:-0.5px;">Peter</p>',
    '<p style="margin:36px auto 0 auto; max-width:400px; font-size:16px; line-height:1.8; color:#4a4640; font-style:italic;">We would love to celebrate with you. Please RSVP using your personal link below.</p>',
    '</td></tr>',
