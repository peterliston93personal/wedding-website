function sendWeddingInvites() {
  var config = {
    ...
    timeIconUrl: 'https://peterliston93personal.github.io/wedding-website/email/20260401%20-%20Illustrations/TP_WEDDING_WEBSITE_ILLUSTRATIONS_Time.png',
    locationIconUrl: 'https://peterliston93personal.github.io/wedding-website/email/20260401%20-%20Illustrations/TP_WEDDING_WEBSITE_ILLUSTRATIONS_Location.png',
    dressIconUrl: 'https://peterliston93personal.github.io/wedding-website/email/20260401%20-%20Illustrations/TP_WEDDING_WEBSITE_ILLUSTRATIONS_Black_Tie.png',
    glassesIllustrationUrl: 'https://peterliston93personal.github.io/wedding-website/illustrations/TP_WEDDING_WEBSITE_ILLUSTRATIONS_Glasses.png',
    lovebirdsIllustrationUrl: 'https://peterliston93personal.github.io/wedding-website/illustrations/TP_WEDDING_WEBSITE_ILLUSTRATIONS_LoveBirds.png',
...
function getHtmlTemplate_() {
  return [
    ...
    '<tr><td style="background-color:#000000; padding:22px 22px 0 22px; text-align:center;">',
    '<p style="margin:0 0 12px 0; font-family:Georgia, Times New Roman, serif; font-size:11px; line-height:1.2; letter-spacing:1.8px; color:#d8d0c2; text-transform:uppercase;">You Have Mail From</p>',
    '<img src="{{INVITE_IMAGE_URL}}" alt="Tara and Peter wedding invitation" width="576" style="display:block; width:100%; max-width:576px; height:auto; border:0; margin:0 auto;">',
    '<p style="margin:12px 0 0 0; padding:0 0 18px 0; font-family:Georgia, Times New Roman, serif; font-size:12px; line-height:1.4; font-style:italic; color:#d8d0c2;">A small preview of the invitation, with the full details below.</p>',
    '</td></tr>',
    '<tr><td style="background-color:#f6f2ea; text-align:center; border-top:1px solid #dfd7c8; border-bottom:1px solid #dfd7c8; padding:10px 8px;">',
    '<p style="margin:0; font-family:Georgia, Times New Roman, serif; font-size:11px; line-height:1.4; color:#26231f; letter-spacing:0.8px; text-transform:uppercase;">We\'re Getting Married &nbsp;&hearts;&nbsp; We\'re Getting Married &nbsp;&hearts;&nbsp; We\'re Getting Married &nbsp;&hearts;&nbsp; We\'re Getting Married</p>',
    '</td></tr>',
